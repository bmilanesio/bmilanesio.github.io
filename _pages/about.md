...
Soy **Estudiante de Doctorado** en [Ciencias de la Educación](https://doctorados.ugr.es/cienciaseducacion/) en la [Universidad de Granada](https://www.ugr.es/), España. Mi principal área de investigación es la Educación Matemática, donde estudio problemáticas relacionadas a la argumentación matemática desde el Enfoque Ontosemiótico ([EOS](https://enfoqueontosemiotico.ugr.es/)). 
